...
'use strict';
{
    ...
    $.fn.actions = function(opts) {
        ...
        $('form#changelist-form input[name="_save"]').on('click', function(event) {
            ...
            if (action_changed) {
                if (list_editable_changed) {
                    return confirm(gettext("You have selected an action, but you havenâ€™t saved your changes to individual fields yet. Please click OK to save. Youâ€™ll need to re-run the action."));
                } else {
                    return confirm(gettext("You have selected an action, and you havenâ€™t made any changes on individual fields. Youâ€™re probably looking for the Go button rather than the Save button."));
                }
            }
        });
    };
